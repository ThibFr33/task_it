...
reminder = Reminder.create!(
  end_date: "06/12/2024 19:00",
  description: 'RDV Dr Papax',
  user_id: morgane.id,
)

reminder = Reminder.create!(
  end_date: "06/12/2024 20:00",
  description: 'Déposer colis',
  user_id: morgane.id,
)

reminder = Reminder.create!(
  end_date: "06/12/2024 21:00",
  description: 'Acheter fleurs',
  user_id: morgane.id,
)

reminder = Reminder.create!(
  end_date: "06/12/2024 22:00",
...
reminder = Reminder.create!(
  end_date: "05/12/2024 15:00",
  description: 'Acheter fleurs',
  user_id: morgane.id,
)

reminder = Reminder.create!(
  end_date: "05/12/2024 11:30",
...
reminder = Reminder.create!(
  end_date: "05/12/2024 22:00",
  description: 'Récupérer colis',
  user_id: jb.id,
)

reminder = Reminder.create!(
  end_date: "05/12/2024 09:00",
  description: 'Déposer colis',
  user_id: jb.id,
)

reminder = Reminder.create!(
  end_date: "05/12/2024 17:00",
  description: 'Acheter fleurs',
  user_id: jb.id,
)

reminder = Reminder.create!(
  end_date: "05/12/2024 19:30",
  description: 'Arroser plantes',
  user_id: jb.id,
)
